...
/**
 * @brief This function was used for global agglomeration in distributed computation.
 ...
 * @param margin_sizes three element tuple, the size of segmentation chunk overlap.
 */
