...
// Reference:
// Meilă, Marina. "Comparing clusterings—an information based distance." Journal
// of multivariate analysis 98.5 (2007): 873-895.
class ContingencyTable {
 ...
 public:
  ...
  ContingencyTable(const Segmentation& gt, const Segmentation& seg){
      ...
      table =
          bu::compressed_matrix()} ContingencyTable(const PySegmentation& gt,
